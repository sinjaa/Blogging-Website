...
def home():
    ...
    if(not str(page).isnumeric()):
        page = 1
    page= int(page)
    #from zero to all number of pages
...
#Post Section & Admin Panel for managing Post Section
...
def contact():
    if (request.method == 'POST'):
        ...
        msg = 'You have successfully sent text !'
        db.session.commit()
        mail.send_message('New blog message from ' + name,
                          sender=email,
